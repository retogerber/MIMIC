...
if bool(getattr(sys, 'ps1', sys.flags.interactive)):
    ...
    snakemake.input["preIMC_to_postIMS_transform"] = "/home/retger/Nextcloud/Projects/test_imc_to_ims_workflow/imc_to_ims_workflow/results/test_split_pre/registrations/preIMC_to_preIMS/B1/test_split_pre_B1-preIMC_to_postIMS_transformations_mod.json"
