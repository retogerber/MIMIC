...
logging.info(f"Shape rotation: {shape_rotation}")
total_rotation=(IMC_rotation_angle/180)*np.pi-shape_rotation
logging.info(f"Total rotation: {total_rotation}")
...
logging.info(f"Center of rotation: {CenterOfRotationPoint}")
