...
if bool(getattr(sys, 'ps1', sys.flags.interactive)):
    ...
    snakemake.input["postIMC_to_postIMS_transform"] = "/home/retger/IMC/data/complete_analysis_imc_workflow/imc_to_ims_workflow/results/NASH_HCC_TMA/registrations/postIMC_to_postIMS/B5/NASH_HCC_TMA_B5-postIMC_to_postIMS_transformations.json"
