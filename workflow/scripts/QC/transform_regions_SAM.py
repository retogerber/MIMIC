...
if bool(getattr(sys, 'ps1', sys.flags.interactive)):
    ...
    snakemake.input['transform_file'] = "/home/retger/Nextcloud/Projects/test_imc_to_ims_workflow/imc_to_ims_workflow/results/test_split_ims/registrations/postIMC_to_postIMS/test_split_ims-postIMC_to_postIMS_transformations_mod.json"
